...
/**
 * This class encapsulate all the relevant information and methods related to a single ping-pong
...
public class ppBall extends Thread {
  ...
  /**
   * Used to return graphics objects, such as GOval, created within a ppBall instance.
   *
   * @return Returns a reference to the GObject of the ball.
   */
